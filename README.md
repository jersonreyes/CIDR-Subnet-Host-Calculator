...
<img src="SS.png" width="100%">
    ...
    $("#hosts-input").click(function() {
    		...
    		function calculate(IP, selected, num_hosts, num_subnets) {
    			...
    			$("#output").html("");
    			$("#additional").html("");
    			var octet, first_IP, last_ip, broadcast_add, first_octet, third_octet, fourth_octet, network_add, subnet=null, CIDR = null;
    			...
    			numbers[0] = 0;numbers[2] = 0;numbers[3] = 0;numbers[4] = 0;
    			numbers[0] = 0; last_ip=0; init=0;
    		}
